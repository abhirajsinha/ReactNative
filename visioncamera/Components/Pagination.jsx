...
const App = () => {
  ...
  //Call the API to fetch data, whenever the user reahces at page end
  useEffect(() => {
    setIsLoading(true);
    axios
  ...
  //Render Item to render the data on UI
  ...
  //Loader function: when to show loader basically
  const renderLoader = () => {
    return isLoading ? (
  ...
  //Main return, returning a FlatList with user data's
  return (
    <>
